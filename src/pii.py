...
EXCLUDED_GENERIC_WORDS = {
    ...
    'область', 'области', 'край', 'края', 'район', 'района', 'районы', 'районов', 'республика', 'республики',
    'новосибирская', 'новосибирской', 'новосибирск', 'новосибирска', 'новосибирску', 'новосибирске', 'нсо', 'рф', 'обл', 'обл.',
    'город', 'города', 'городу', 'городе', 'городские', 'городских', 'г.', 'г',
    'москва', 'москвы', 'москве',
    'тбо', 'тко',
    'октябрьский', 'октябрьского', 'дзержинский', 'дзержинского', 'первомайский', 'первомайского',
    'центральный', 'центрального', 'железнодорожный', 'железнодорожного', 'калининский', 'калининского',
    'заельцовский', 'заельцовского', 'кировский', 'кировского', 'ленинский', 'ленинского', 'советский', 'советского',
